...
| 4            | Redes Neuronales Recurrentes  [Jupyter](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Pr%C3%A1cticas%20de%20Laboratorio/Pr%C3%A1ctica%204%20Sarcasmo/TF-Sarcasmo.ipynb)  [PDF](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Pr%C3%A1cticas%20de%20Laboratorio/Pr%C3%A1ctica%204%20Sarcasmo/Pr%C3%A1ctica_4_TF_Sarcasmo.pdf)                | News Headlines Dataset For Sarcasm Detection                           | Exactitud | Crear un modelo que pueda hacer análisis de texto para reconocer textos sarcásticos y no sarcásticos                            |
| 5            | Uso de TensorFlow Distribuido  [.py](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Pr%C3%A1cticas%20de%20Laboratorio/Pr%C3%A1ctica%205%20TensorFlow%20Distribuido/worker.py)  [PDF](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Pr%C3%A1cticas%20de%20Laboratorio/Pr%C3%A1ctica%205%20TensorFlow%20Distribuido/Instrucciones%20TF%20distribuido.pdf)                | 3 nodos virtuales con CPU y GPU c/u                           | No aplica | Mostrar cómo se realiza la instalación de TensorFlow y cómo se comunican los nodos.                            |
| 6            | Transferencia de Aprendizaje  [Jupyter](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Pr%C3%A1cticas%20de%20Laboratorio/Pr%C3%A1ctica%206%20Barcos/TF-Barcos.ipynb)  [PDF](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Pr%C3%A1cticas%20de%20Laboratorio/Pr%C3%A1ctica%206%20Barcos/Pr%C3%A1ctica_6_TF_Barcos.pdf)                | Game of Deep Learning: Ship dataset                           | Exactitud, Precisión y Matriz de Confusión | Crear un modelo que pueda hacer análisis de texto para reconocer textos sarcásticos y no sarcásticos                            |

# Actividades Complementarias
| N°  Práctica | Nombre                                                     | Dataset                                         | Criterio de  Evaluación     | Descripción                                                                                                                                                                     |
|--------------|------------------------------------------------------------|-------------------------------------------------|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1            | Clasificación Multiclase de Letras  [Jupyter](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Actividades%20Complementarias/Actividad%201%20Clasifiaci%C3%B3n%20Multiclase/Actividad%201%20Ejemplo.ipynb)                 | A-Z Handwritten Alphabets in .csv format                           | Exactitud | El alumno debe entrenar un modelo para reconocer letras escritas a mano y comprobar su efectividad haciendo predicción a una frase escrita a mano.                             |
| 2            | Análisis de Sentimientos de Tweets  [Jupyter](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Actividades%20Complementarias/Actividad%202%20An%C3%A1lisis%20de%20Sentimientos%20de%20Tweets/Actividad%202%20Ejemplo.ipynb)                  | Twitter US Airline Sentiment                           | Exactitud | El alumno debe hacer limpieza de los datos de entrenamiento, diseñar un modelo a partir de ello y hacer una prueba con un texto de su autoría.                             |
| 3            | Sarcasmo en Noticias Distribuido  [Jupyter](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Actividades%20Complementarias/Actividad%203%20Sarcasmo%20en%20Noticias%20Distribuido/Actividad%203%20Ejemplo.ipynb)                | News Headlines Dataset For Sarcasm Detection                           | Exactitud, Precisión y Velocidad de Ejecución | El alumno debe probar el TensorFlow ejecutando la actividad en uno de los nodos del servidor y ejecutarlo de manera paralela en los tres nodos del mismo.                             |
| 4            | Creación de Red Neuronal  [Jupyter](https://github.com/BruceHGinori/Practicas-DL/blob/main/Pr%C3%A1cticas/Actividades%20Complementarias/Actividad%204%20Red%20Neuronal%20DIY%20(Do%20It%20Yourself)/Actividad%204%20Ejemplo.ipynb)                 | Elección del Alumno                           | Elección del Alumno | El alumno debe mostrar lo aprendido a lo largo del curso creando su propia red neuronal para realizar un análisis completo de un dataset de su elección y mostrar resultados concretos.                            |
