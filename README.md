...
| 5            | Uso de TensorFlow Distribuido  [Jupyter]()  [PDF]()                | 3 nodos virtuales con CPU y GPU c/u                           | No aplica | Mostrar cómo se realiza la instalación de TensorFlow y cómo se comunican los nodos.                            |
